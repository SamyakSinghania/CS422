...
public:
   ...
   /* processor state */
   Info IF,ID,EX,MEM,WB,IF_ID,ID_EX,EX_MEM,MEM_WB,NOP;
   unsigned int decoder_stall,syscall_stall,branch_stall;
   unsigned int 	_gpr[32];		// general-purpose integer registers
   unsigned int _gpr_b[32];
   ...
   unsigned int _flags2[16];
   unsigned int _flag3;
   unsigned int _hib, _lob; 
